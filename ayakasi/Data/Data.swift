let ayakasis: [Ayakasi] = [
    ...
    Ayakasi(
        ...
        description: "中国神話に登場する怪異的存在。炎帝に仕えた戦神であったが、黄帝に敗れ、首を斬り落とされるという最期を迎えたとされる。しかし刑天はそこで滅びることなく、胸に乳を目、臍を口として再び立ち上がり、斧と盾を手に舞い続けたという。\n\n首を失った後も戦う姿は、勝敗や理屈を超えた執念の象徴として語られる。視界も言葉も失ったはずの存在が、なおも武を振るうその姿は、人の理解を超えた異様さを帯びている。倒されてもなお戦いをやめないその様子から、刑天は神というよりも、怒りと闘争心そのものが形を持った怪異として恐れられた。\n\n刑天は勝利を求める存在ではなく、戦うこと自体をやめられなかった存在とされる。その姿は、理不尽な敗北や屈辱を受け入れられず、終わりを失った者の成れの果てとして、後世に語り継がれている。",
